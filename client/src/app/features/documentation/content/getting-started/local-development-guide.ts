...
`,
      bullets: [
        ...
        'Use npm start to run the Angular dev server from `client/`.',
...
`,
      bullets: [
        'Use `server/` for BFF code in this repository.',
        'Replace the placeholder server scripts with real BFF scripts when the module is implemented.',
...
`,
      bullets: [
        'Use the sibling `tonys-workbench-services` repository for Java service development.',
