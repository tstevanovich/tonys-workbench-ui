...
\`\`\`text
Use Angular MCP to review client/src/app/app-shell/header/app-shell-header.html and
client/src/app/app-shell/header/app-shell-header.ts. Tell me whether this follows modern
Angular and Angular Material patterns. Do not edit anything yet.
\`\`\`

\`\`\`text
Use Angular MCP to review client/src/app/app.routes.ts for lazy loading, route organization,
