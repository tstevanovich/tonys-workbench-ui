  ...
  sections: [
    {
      ...
      bullets: [
        ...
        'Use `tonys-workbench-ui` as the repository for the Angular client and Node.js BFF.',
        'Use `tonys-workbench-services` as the repository for Java/Spring Boot microservices.',
        ...
        'Keep browser-facing OpenAPI contracts with the UI/BFF repository, Java service OpenAPI contracts with the services repository, and database migration contracts with the database repository.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Concrete BFF implementation dependencies, Java service package names, background job platform, and scheduled job platform.',
