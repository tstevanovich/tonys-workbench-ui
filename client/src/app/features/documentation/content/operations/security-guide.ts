...
`,
      bullets: [
        ...
        'Use the server workspace check script for Node.js route, validation, REST client, and dependency checks.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Run SAST scanning as part of the pipeline for frontend, Node.js server, and Java service code where those layers exist.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Keep browser tokens and service-to-service credentials out of Angular; place token mediation and downstream auth in the Node.js server or deeper server-side layers.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Use the Node.js server to keep OAuth token handling server-side for browser applications where that pattern is available.',
        'Enforce authorization in optional Java services when durable service APIs exist, even when the frontend hides unauthorized UI and the Node.js server performs request mediation.',
