  ...
  sections: [
    {
      ...
      bullets: [
        ...
        'Define Material themes in src/material-theme.scss with @angular/material Sass APIs.',
...
`
    },
    {
      ...
      bullets: [
        'Keep available theme metadata in src/app/core/theme/app-theme.ts.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Keep layout styles local to components, but keep theme generation centralized in src/material-theme.scss.',
    ...
    },
    {
      ...
      bullets: [
        'Add the Material theme class in src/material-theme.scss.',
