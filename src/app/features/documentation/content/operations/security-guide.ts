...
`,
      bullets: [
        ...
        'Use BFF check scripts for Node.js route, validation, and dependency checks when the BFF exists.',
        'Use Gradle check for Java service tests, static checks, and dependency checks when a Java service exists.'
      ]
    },
    {
