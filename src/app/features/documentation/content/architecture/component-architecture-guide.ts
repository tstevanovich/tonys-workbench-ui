  ...
  sections: [
    {
      ...
      bullets: [
        ...
        'Shared UI components live under src/app/shared/ui and must not depend on feature code.',
        'Shared form components live under src/app/shared/forms and own reusable form rendering, validation messages, and control adapters.',
