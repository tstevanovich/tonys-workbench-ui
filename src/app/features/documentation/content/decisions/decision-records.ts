  ...
  sections: [
    {
      ...
      bullets: [
        ...
        'Use Java 25 LTS, Spring Boot, SQL Server, OIDC/OAuth, Kafka, OpenShift, deployment workflow integration, Elastic-compatible observability, OpenTelemetry-compatible instrumentation, and Java APM agent instrumentation as the enterprise-aligned full-stack baseline.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Concrete backend package names, background job platform, and scheduled job platform.',
